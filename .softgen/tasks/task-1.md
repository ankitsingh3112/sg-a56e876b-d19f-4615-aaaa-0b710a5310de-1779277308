...
## Notes
Set up complete design system (colors, fonts, component theming) + build homepage with hero, benefits, services preview, testimonials. First impression must convey elite recovery lab precision.
...
- Design system tokens work across all sections
